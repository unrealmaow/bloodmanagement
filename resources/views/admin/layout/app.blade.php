...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
                    ...
                    <div class="modal-body">
                        <ul class="row p-3">
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt=""
                                            src="{{ url('/sash') }}/assets/images/flags-img/us_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                            src="{{ url('/sash') }}/assets/images/flags-img/malaysia.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                            src="{{ url('/sash') }}/assets/images/flags-img/turkey.jpg"
        ...
        <script src="{{ url('/sash') }}/assets/plugins/datatable/js/dataTables.bootstrap5.js">
        </script>
        <script src="{{ url('/sash') }}/assets/plugins/datatable/dataTables.responsive.min.js">
        </script>
        ...
        <!-- INTERNAL Vector js -->
        <script src="{{ url('/sash') }}/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js">
        </script>
        <script
            src="{{ url('/sash') }}/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js">
        </script>
        ...
        <!-- TypeHead js -->
        <script src="{{ url('/sash') }}/assets/plugins/bootstrap5-typehead/autocomplete.js">
        </script>
        ...
        <script src="{{ url('/sash') }}/assets/plugins/fancyuploder/jquery.iframe-transport.js">
        </script>
        <script src="{{ url('/sash') }}/assets/plugins/fancyuploder/jquery.fancy-fileupload.js">
        </script>
