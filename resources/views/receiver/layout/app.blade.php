...
<body class="app sidebar-mini ltr light-mode">
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="{{url('/sash')}}/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{url('/sash')}}/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                                ...
                                                <div class="header-dropdown-list message-menu">
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span
                                                            ...
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/products/3.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span
                                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/products/5.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span
                                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/products/7.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span
                                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/products/1.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span
                                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/products/2.jpg"></span>
                                                        <div class="wd-50p">
                                                ...
                                                <div class="message-menu message-menu-scroll">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/1.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/15.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/12.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/4.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/3.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                <img src="{{url('/sash')}}/assets/images/avatars/default.avif" alt="profile-user"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="dropdown-divider m-0"></div>
                                                <a class="dropdown-item" href="{{url('/receiver/profile')}}">
                                                ...
                                                <a class="dropdown-item" href="#" onclick="logoutFunction(event)">
                                                    <i class="dropdown-icon fe fe-alert-circle"></i> <span>Sign out<span>
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{url('/receiver/dashboard')}}">
                            <img src="{{url('/sash')}}/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{url('/sash')}}/assets/images/brand/icon-white.png" class="header-brand-img toggle-logo"
                                alt="logo">
                            <img src="{{url('/sash')}}/assets/images/brand/icon-dark.png" class="header-brand-img light-logo" alt="logo">
                            <img src="{{url('/sash')}}/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                                                        ...
                                                        <div class="Annoucement_card">
                                                            <div class="text-center">
                                                                <div>
                                                                    ...
                                                                    <div class="bg-layer">
                                                                        <img src="{{url('/sash')}}/assets/images/media/37.png" alt="img" class="text-center mx-auto">
                                                                    </div>
                                                    ...
                                                    <div class="main-chat-list tab-pane">
                                                        <div class="media border-0 px-1 new border-top-0">
                                                            <div class="main-img-user online">
                                                                <img alt="" src="{{url('/sash')}}/assets/images/users/5.jpg">
                                                            </div>
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user">
                                                                <img alt="" src="{{url('/sash')}}/assets/images/users/6.jpg"> <span>3</span>
                                                            </div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user online"><img alt="" src="{{url('/sash')}}/assets/images/users/9.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/4.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/21.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/5.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/3.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/7.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new border-bottom-0">
                                                            <div class="main-img-user"><img alt="" src="{{url('/sash')}}/assets/images/users/6.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                        ...
                        <div class="tab-pane" id="sidebar-side2">
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/2.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/11.jpg"><span
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/10.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/13.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/7.jpg"><span
                                                class="avatar-status bg-success"></span></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/9.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="{{url('/sash')}}/assets/images/users/14.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <ul class="row p-3">
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="" src="{{url('/sash')}}/assets/images/flags-img/us_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/italy_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/spain_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/india_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/french_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/russia_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/germany_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="{{url('/sash')}}/assets/images/flags-img/argentina.jpg"
                                        class="me-3 language"></span>Argentina
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="{{url('/sash')}}/assets/images/flags-img/malaysia.jpg"
                                        class="me-3 language"></span>Malaysia
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="{{url('/sash')}}/assets/images/flags-img/turkey.jpg"
    ...
    <!-- PIETY CHART JS-->
    <script src="{{url('/sash')}}/assets/plugins/peitychart/jquery.peity.min.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/peitychart/peitychart.init.js"></script>

    <!-- SIDEBAR JS -->
    <script src="{{url('/sash')}}/assets/plugins/sidebar/sidebar.js"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="{{url('/sash')}}/assets/plugins/p-scroll/perfect-scrollbar.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/p-scroll/pscroll.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/p-scroll/pscroll-1.js"></script>

    <!-- INTERNAL CHARTJS CHART JS-->
    <script src="{{url('/sash')}}/assets/plugins/chart/Chart.bundle.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/chart/utils.js"></script>

    <!-- INTERNAL SELECT2 JS -->
    <script src="{{url('/sash')}}/assets/plugins/select2/select2.full.min.js"></script>

    <!-- INTERNAL Data tables js-->
    <script src="{{url('/sash')}}/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/datatable/dataTables.responsive.min.js"></script>

    <!-- INTERNAL APEXCHART JS -->
    <script src="{{url('/sash')}}/assets/js/apexcharts.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/apexchart/irregular-data-series.js"></script>

    <!-- INTERNAL Flot JS -->
    <script src="{{url('/sash')}}/assets/plugins/flot/jquery.flot.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/flot/jquery.flot.fillbetween.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/flot/chart.flot.sampledata.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/flot/dashboard.sampledata.js"></script>

    <!-- INTERNAL Vector js -->
    <script src="{{url('/sash')}}/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- SIDE-MENU JS-->
    <script src="{{url('/sash')}}/assets/plugins/sidemenu/sidemenu.js"></script>

	<!-- TypeHead js -->
	<script src="{{url('/sash')}}/assets/plugins/bootstrap5-typehead/autocomplete.js"></script>
    <script src="{{url('/sash')}}/assets/js/typehead.js"></script>

    <!-- INTERNAL INDEX JS -->
    <script src="{{url('/sash')}}/assets/js/index1.js"></script>
    ...
    <!-- FILE UPLOADES JS -->
    <script src="{{url('/sash')}}/assets/plugins/fileuploads/js/fileupload.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/fileuploads/js/file-upload.js"></script>

    <!-- INTERNAL File-Uploads Js-->
    <script src="{{url('/sash')}}/assets/plugins/fancyuploder/jquery.ui.widget.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/fancyuploder/jquery.fileupload.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/fancyuploder/jquery.iframe-transport.js"></script>
    <script src="{{url('/sash')}}/assets/plugins/fancyuploder/jquery.fancy-fileupload.js"></script>
